...
# Import data files.
d1 = data.table(read.csv('data/03-04.csv', header = T, stringsAsFactors = F))
d2 = data.table(read.csv('data/04-05.csv', header = T, stringsAsFactors = F))
d3 = data.table(read.csv('data/05-06.csv', header = T, stringsAsFactors = F))
d4 = data.table(read.csv('data/06-07.csv', header = T, stringsAsFactors = F))
d5 = data.table(read.csv('data/07-08.csv', header = T, stringsAsFactors = F))
d6 = data.table(read.csv('data/08-09.csv', header = T, stringsAsFactors = F))
d7 = data.table(read.csv('data/10-11.csv', header = T, stringsAsFactors = F))
d8 = data.table(read.csv('data/11-12.csv', header = T, stringsAsFactors = F))
d9 = data.table(read.csv('data/12-13.csv', header = T, stringsAsFactors = F))
d10 = data.table(read.csv('data/13-14.csv', header = T, stringsAsFactors = F))
d11 = data.table(read.csv('data/14-15.csv', header = T, stringsAsFactors = F))
d12 = data.table(read.csv('data/15-16.csv', header = T, stringsAsFactors = F))
...
write.csv(premier_data, 'premier_data.csv', row.names = F)