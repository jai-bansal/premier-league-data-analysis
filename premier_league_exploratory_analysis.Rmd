...
I'll use a random forest to predict matche outcomes (home win, away win, draw).   
...
So, what's the answer to question that started this section? Yes, technically. The refined model does better than the null model, chance, and the initial model. But would I bet my life savings on it? Definitely not.
